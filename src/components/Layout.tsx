    ...
    <div className="min-h-screen bg-gray-100 flex flex-col md:flex-row">
      ...
      <header className="bg-white text-csc-dark flex items-center justify-between px-3.5 py-2.5 md:hidden border-b-4 border-csc-gold shadow-sm sticky top-0 z-30">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* Pílula de Cargo (comutador de perfil, se tiver mais do que um) */}
          <button
            type="button"
      ...
      {/* Modal de Alternância de Papel / Role Switcher — só acessível pela pílula
          de cargo do cabeçalho (topo da página); sidebar e gaveta não a oferecem. */}
      {isRoleModalOpen && (
        <div
